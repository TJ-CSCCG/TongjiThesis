...
\begin{table}[htbp]
  ...
  \begin{tabular}{ccll}
    \toprule
    \textbf{层级} & \textbf{\LaTeX{} 命令} & \textbf{\texttt{field=science}（理工科，默认）} & \textbf{\texttt{field=humanities}（文科）} \\
    \midrule
    1 & \texttt{\textbackslash chapter}       & 1, 2, 3      & 一、二、三 \\
    2 & \texttt{\textbackslash section}       & 1.1, 1.2     & （一）（二） \\
    3 & \texttt{\textbackslash subsection}    & 1.1.1, 1.1.2 & 1.\ 2. \\
    4 & \texttt{\textbackslash subsubsection} & A, B, C      & （1）（2）（3） \\
    5 & \texttt{\textbackslash paragraph}     & a, b, c      & \Circled{1}\Circled{2}\Circled{3} \\
    \bottomrule
  \end{tabular}
\end{table}
