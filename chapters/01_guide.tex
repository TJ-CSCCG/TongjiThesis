...
\begin{table}[htbp]
  ...
  \begin{tabularx}{\linewidth}{l l X}
    ...
    \texttt{doctype} & \texttt{thesis} & 文档类型。\texttt{thesis}（默认）：本文档描述的论文正文流程，不受影响；\texttt{taskbook}/\texttt{proposal}/\texttt{midterm}：分别生成任务书/开题报告/中期报告，详见\cref{sec:doctypes}。 \\
    \bottomrule
  \end{tabularx}
\end{table}
...
\begin{table}[htbp]
  ...
  \begin{tabularx}{\linewidth}{l l l X}
    ...
    \midrule
    \texttt{thesis}   & 论文正文（默认） & \verb|main.tex|     & 沿用\cref{tab:doc-structure}描述的完整封面/信息页/前置/正文/参考文献/附录/谢辞流程，不受本节影响。 \\
